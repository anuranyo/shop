...
<body class="h-full font-sans bg-cover bg-center bg-no-repeat">
        ...
        <div class="max-w-lg mx-auto bg-black text-white p-8 rounded-lg">
            ...
            <form action="register_process.php" method="post">
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 focus:outline-none focus:border-blue-500" placeholder="Name">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-6 relative">
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 focus:outline-none focus:border-blue-500">
                    <span id="toggleConfirmPassword" class="absolute right-3 top-11 text-gray-400 cursor-pointer">🙈</span>
                </div>
                <button type="submit" class="w-full bg-white text-black py-3 px-4 rounded-lg font-bold">Register</button>
            </form>
        </div>
    </main>
